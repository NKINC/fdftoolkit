...
#End Region
        ...
        Private Function FDFCheckChar(ByVal strINPUT As String) As String
            ...
            For Each ch As Char In tmpScript.ToCharArray
                ...
                ElseIf Not pre_char = "\" And ch = "'" Then
                    str_bld.Append("\'")
                ElseIf Not pre_char = "\" And ch = "Т" Then
                    str_bld.Append("\'")
                ElseIf Not pre_char = "\" And ch = "" Then
                    str_bld.Append("\")
                ElseIf Not pre_char = "\" And ch = "" Then
                ...
                ElseIf Not pre_char = "\" And ch = "" Then
                    str_bld.Append("\")
                ElseIf pre_char = "\" And ch <> "(" And ch <> ")" And ch <> Chr(13) And ch <> Chr(10) And ch <> "'" And ch <> "Т" And ch <> "" Then
                    str_bld.Append("\\" & ch)
                Else
                    str_bld.Append(ch)
                End If
        ...
        Private Function FDFCheckCharReverse2(ByVal strINPUT As String()) As String()
            ...
            For Each tmpScript In strINPUT
                ...
                If tmpScript.IndexOf("\'") > 0 Then
                    tmpScript = tmpScript.Replace("\'", "'")    ' \r\n
                End If
                If tmpScript.IndexOf("\Т") > 0 Then
                    tmpScript = tmpScript.Replace("\'", "Т")    ' \r\n
                End If
                ...
                If intField(0) > 0 Then
                    Do While FldEnd > intField(2) + 7
                        ...
                        If objNum = 1 Then
                            ...
                            If FDFDox.Differences.StartsWith("у╧╙") Then
                                FDFDox.Differences = ""
                            End If
                ...
                Select Case xType
                    Case FDFType.FDF
                        If AppendSaves And FDFDox.FDFHasChanges Then
                            '	"%FDF-1.2" & vbNewLine & 
                            retString = "%FDF-1.2" & vbNewLine & "%ту╧╙" & vbNewLine & "1 0 obj<< /Version /" & IIf(FDFDox.Version <> "", FDFDox.Version, "1.4") & " /FDF" & IIf(FDFDox.Annotations <> "" And AppendSaves = True, "<< /Annots [" & FDFDox.Annotations & "] ", "<<")
                        Else
                            '"%FDF-1.2" & vbNewLine & 
                            retString = "%FDF-1.2" & vbNewLine & "%ту╧╙" & vbNewLine & "1 0 obj<< /Version/1.6 /FDF << "
                        End If
                    Case FDFType.xFDF
